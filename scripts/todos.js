...
(async function () {
    ...
    document.querySelector("[data-todos-form]").addEventListener("submit", handleAddTodo);
    document.querySelector("[data-todos-list]").addEventListener("click", handleDeleteTodo);
    document.querySelector("[data-todos-list]").addEventListener("change", handleUpdateTodo);
